...
const projectTitles = {
  es: {
    ...
    rluabogados: 'RL Abogados — Plataforma legal corporativa | Caso IrigoyenDev',
  ...
  en: {
    ...
    rluabogados: 'RL Abogados — Corporate Legal Platform | IrigoyenDev Case Study',
  ...
  da: {
    ...
    rluabogados: 'RL Abogados — Juridisk virksomhedsplatform | IrigoyenDev-case',
  ...
  no: {
    ...
    rluabogados: 'RL Abogados — Juridisk bedriftsplattform | IrigoyenDev-case',
