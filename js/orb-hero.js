...
const FRAG = /* glsl */ `
  ...
  const vec3 baseColor1 = vec3(0.145098, 0.388235, 0.921569);
  const vec3 baseColor2 = vec3(0.298039, 0.760784, 0.913725);
  const vec3 baseColor3 = vec3(0.019608, 0.098039, 0.301961);
...
function startHeroOrb() {
  const heroOrbEl = document.getElementById('hero-orb');
  if (!heroOrbEl) return;

  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    heroOrbEl.classList.add('hero-orb--static');
    return;
  }
  ...
  try {
    ...
    console.error('Hero Orb failed to initialize:', err);
  }
}

if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', startHeroOrb);
} else {
  startHeroOrb();
}
